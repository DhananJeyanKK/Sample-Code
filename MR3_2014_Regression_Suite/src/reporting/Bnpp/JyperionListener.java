...
import com.bnpp.methods.BaseClassReport;
 ...
 */
   public class JyperionListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		String file="/Users/mobilitytcs/Desktop/Automation/Selenium/Results/Failure-"+randomno+".png";
			
		try{         
			BaseClassReport.takeSnapShot(BaseClassReport.getDriver(),file);
		}catch (Exception e){
			e.printStackTrace();
		}
		...
		if (throwable != null) {
			...
			Chunk imdb = new Chunk(throwable.toString(), 
							new Font(Font.TIMES_ROMAN, Font.DEFAULTSIZE, Font.UNDERLINE));
